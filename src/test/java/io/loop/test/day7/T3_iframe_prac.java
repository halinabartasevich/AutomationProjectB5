...
public class T3_iframe_prac extends TestBase {
    ...
    */
    ...
    public void iframeValidation() {
        ...
        assertEquals(actualLeft.trim(), "LEFT", "Left text doesn't match");
        ...
        assertEquals(actualMiddle.trim(), "MIDDLE", "Middle text doesn't match");
        ...
        assertEquals(actualRight.trim(), "RIGHT", "Right text doesn't match");
