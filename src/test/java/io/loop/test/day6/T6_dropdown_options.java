...
@Test
    ...
    // select yellow and validate ny index
    dropdown.selectByIndex(3);

    //validate Yellow
    String actualYellow = dropdown.getFirstSelectedOption().getText();
    String expectedYellow = "Yellow";
    assertEquals(actualYellow, expectedYellow, "Actual " + actualYellow + " Does NOT match expected expected: " + expectedYellow);


    // select RED and validate by Value
    ...
    //   select WHITE  and validate by VISIBLE TEXT (=CONTAINS TEXT)
